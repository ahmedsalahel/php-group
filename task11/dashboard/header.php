...
if (isset($_SESSION['user_id'])) {
    $stat = "select * from new_users where id = $_SESSION[user_id]";
    $query = mysqli_query($connection, $stat);
    $data = mysqli_fetch_assoc($query);

    $stat2 = 'SELECT count(*) AS total FROM `new_users`';
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block user-dropdown">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="rounded-circle header-profile-user" src="../uploads/profile/<?= $data['image'] ?? 'default.png' ?>" alt="Header Avatar">
